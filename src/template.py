        ...
        <body
            ...
            <div
                ...
                <div style="padding: 20px 40px 40px 40px;">
                    ...
                    <p>Thank you for joining us for CISON’s PRS on <strong>Basic Structural Modelling for Social and Business Research.</strong></p>
    ...
    def second_prs_template(name):
        ...
        <body
            ...
            <div
                ...
                <div style="padding: 20px 40px 40px 40px;">
                    <h2 style="color: #1A693D; text-align: center;">Dear {name},</h2>
                    <hr style="border: 0; border-top: 1px solid #eee; margin: 20px 0;">
